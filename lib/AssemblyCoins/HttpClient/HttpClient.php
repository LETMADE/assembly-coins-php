...
namespace AssemblyCoins\HttpClient;

use Guzzle\Http\Client as GuzzleClient;
use Guzzle\Http\ClientInterface;
use Guzzle\Http\Message\RequestInterface;

use AssemblyCoins\HttpClient\AuthHandler;
use AssemblyCoins\HttpClient\ErrorHandler;
use AssemblyCoins\HttpClient\RequestHandler;
use AssemblyCoins\HttpClient\Response;
use AssemblyCoins\HttpClient\ResponseHandler;
